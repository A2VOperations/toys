...
const SUPPORT_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "919999999999"
const sections = [
  {
    id: "s1",
    title: "Introduction",
    content: (
      <p>
        Welcome to Toys For Kids! We are committed to protecting your personal information and your right
        to privacy. This policy explains how we collect, use, and share information about you when
        you use our website or purchase our products. By using Toys For Kids, you agree to the terms of
        this policy. Questions? Reach us at{" "}
        <a href={`mailto:${SUPPORT_EMAIL}`} className="text-rose-300 font-bold hover:underline">
          {SUPPORT_EMAIL}
        </a>.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="font-semibold text-pink-950 mb-1">Information you provide:</p>
        <ul className="list-disc pl-5 mb-3 space-y-1">
          <li>Name, email, phone number, and shipping / billing address when placing an order</li>
          <li>Payment information (processed securely — we do <strong className="text-pink-950">not</strong> store card details)</li>
          <li>Account credentials if you create an account</li>
          <li>Reviews, ratings, or feedback you submit</li>
        </ul>
        <p className="font-semibold text-pink-950 mb-1">Information collected automatically:</p>
    ...
    content: (
      <>
        <ul className="list-disc pl-5 mb-3 space-y-1">
          ...
          <li>Send promotional emails — <strong className="text-pink-950">only if you opt in</strong></li>
        ...
        <div className="bg-pink-50 border-l-4 border-pink-400 rounded-r-xl px-4 py-3 text-sm text-pink-800">
           You can unsubscribe from marketing emails at any time using the link at the bottom of any promotional message.
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">We <strong className="text-pink-950">never sell</strong> your personal data. We share it only with trusted partners:</p>
        <ul className="list-disc pl-5 mb-3 space-y-1">
          <li>Shipping &amp; logistics partners — to deliver your orders</li>
          <li>Payment processors — to securely handle transactions</li>
          <li>Analytics providers — to understand site usage (data is anonymised)</li>
          <li>Legal authorities — if required by law or court order</li>
        </ul>
        <div className="bg-pink-50 border-l-4 border-pink-400 rounded-r-xl px-4 py-3 text-sm text-pink-800">
           All third-party partners are contractually required to handle your data responsibly and in accordance with applicable data protection laws.
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">Toys For Kids uses cookies to enhance your browsing experience and analyse site traffic.</p>
        <ul className="list-disc pl-5 mb-2 space-y-1">
          <li><strong className="text-pink-950">Essential cookies</strong> — required for core functionality (e.g. shopping cart)</li>
          <li><strong className="text-pink-950">Analytics cookies</strong> — help us understand usage patterns</li>
          <li><strong className="text-pink-950">Marketing cookies</strong> — used to show relevant ads (only with consent)</li>
        </ul>
        <p>You can control or disable cookies through your browser settings. Disabling essential cookies may affect site functionality.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1">
        <li>Order &amp; transaction data: retained for up to <strong className="text-pink-950">7 years</strong> for legal purposes</li>
        <li>Account data: retained up to <strong className="text-pink-950">2 years</strong> after account deletion</li>
  ...
  },
  {
    ...
    content: (
      <>
        <ul className="list-disc pl-5 mb-3 space-y-1">
          <li><strong className="text-pink-950">Access</strong> — request a copy of the data we hold about you</li>
          <li><strong className="text-pink-950">Rectification</strong> — ask us to correct inaccurate or incomplete data</li>
          <li><strong className="text-pink-950">Erasure</strong> — request deletion of your personal data</li>
          <li><strong className="text-pink-950">Portability</strong> — receive your data in a machine-readable format</li>
          <li><strong className="text-pink-950">Object</strong> — opt out of processing for marketing purposes</li>
        </ul>
        <div className="bg-pink-50 border-l-4 border-pink-400 rounded-r-xl px-4 py-3 text-sm text-pink-800">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">
          Toys For Kids sells products for children, but our website is intended for adults (18+).
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        Toys For Kids after any changes constitutes acceptance of the updated policy.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1">
        <li><strong className="text-pink-950">Email:</strong> {SUPPORT_EMAIL}</li>
        <li><strong className="text-pink-950">Phone:</strong> {SUPPORT_NUMBER}</li>
        <li><strong className="text-pink-950">Address:</strong> Toys For Kids Store, New Delhi, India</li>
      </ul>
    ),
  },
];
  ...
  return (
    ...
    <div className="bg-pink-100 px-4 py-10 relative overflow-hidden">
      ...
      ><div className="absolute -top-6 -left-6 w-40 h-40 rounded-full bg-white/10 pointer-events-none" />
            ...
            <div key={s.id}>
              <div id={s.id} className="mb-7 scroll-mt-5">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h2 className="font-black text-lg text-pink-950">{s.title}</h2>
                </div>
        ...
        {/* Footer */}
        <div className="bg-pink-50 border-t border-pink-200 px-8 py-4 text-center text-xs text-pink-400 font-semibold">
          © <span suppressHydrationWarning>{new Date().getFullYear()}</span> Toys For Kids · Made with ❤️ for little ones ·{" "}
