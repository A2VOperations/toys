  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.waveContainer}>
        ...
        >
          <path
            d="M0,20 C120,40 240,0 360,20 C480,40 600,0 720,20 C840,40 960,0 1080,20 C1200,40 1320,0 1440,20 L1440,0 L0,0 Z"
            fill="#fce4ef"
          />
        </svg>
      </div>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.waSection}>
            ...
            <p className={styles.waDesc}>
              Drop your name and we&apos;ll reach out via WhatsApp with updates
              &amp; exclusive deals!
            </p>
