...
export default function SettingsPage() {
  ...
  async function handleSave(e) {
    ...
    if (form.newPassword) {
      if (!form.currentPassword)
        return showToast("error", "Enter your current password.");
  ...
  if (loading) {
    return (
      <div
        className="min-h-screen flex flex-col items-center justify-center gap-4 bg-gray-200"
  ...
  return (
    ...
    >
      <style>{`
        ...
        .s-label { display:block; font-size:14px; font-weight:800; letter-spacing:0.18em; text-transform:uppercase; color:#E84393; margin-bottom:8px; }
        .s-section { font-size:15px; font-weight:900; letter-spacing:0.2em; text-transform:uppercase; color:#1a1a2e; display:flex; align-items:center; gap:8px; margin-bottom:16px; }
      ...
      <div className="max-w-2xl mx-auto bg-gray-100 rounded-3xl p-10 mb-10">
        {/* BACK + HEADER */}
        <div className="mb-8">
          <button
            onClick={() => router.back()}
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="s-card space-y-4">
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold text-gray-400 mt-1.5 ml-1">
          ...
          <div className="s-card space-y-4">
              ...
              <div key={key}>
                ...
                <div className="pass-wrap">
                  <input
                    ...
                    onChange={set(key)}
                    placeholder={
                      key === "newPassword" ? "Min. 6 characters" : "••••••••"
                    }
                  />
                  <button
                    type="button"
            ...
            {form.newPassword && form.confirmPassword && (
              <p
                className={`text-[11px] font-bold ml-1 ${form.newPassword === form.confirmPassword ? "text-green-500" : "text-pink-500"}`}
              >
                {form.newPassword === form.confirmPassword
                  ? "✅ Passwords match"
                  : "❌ Don't match"}
